export const eventsData = [
...

  {
    ...
    eventType:"non-tech",
    description:
        "Join us for an exhilarating Free Fire Tournament! Whether you're a seasoned player or a newcomer looking to showcase your skills, this event promises intense battles, strategic gameplay, and a chance to win exciting prizes.",
    rules: [
      "Each team must consist of 4 players.",
      "Players must adhere to fair play and sportsmanship.",
      "Any form of cheating or hacking will result in immediate disqualification.",
      "Teams must check in 15 minutes before the event starts.",
      "According to the number of entries, final round will announced later ."
    ],
    rounds : [
      ["Date","23 / 08 / 2024"],
...

  {
    ...
    rules: [
      ...
      "Only the first 30 teams to register will be considered for the online round",
      "For the online round, all team members must join using their team name in the meet.",
      "Only the top 12 teams will be invited for the offline round.",
      "Embrace fair play and sportsmanship at all times."
    ],
    rounds : [
      ["Date","23 / 08 / 2024"],
      ["Time", "07:00 pm  -  09:00 pm"],
